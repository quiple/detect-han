...
현재 포함된 데이터는 Unicode 17.0.0 기준 14,313개 레코드입니다. 압축 데이터는 9,101바이트이고, 복원된 검색 테이블은 57,252바이트입니다.
현재 ESM 빌드는 약 13.3KiB(최대 gzip 압축 시 약 9.1KiB), npm 패키지는 약 15.5KiB입니다. 데이터 갱신에 따라 크기는 조금 달라질 수 있습니다.
